...
function Jsoneditpage() {
  ...
  const singleremocrd = ()=>
    {
      axios.get(`http://localhost:4500/user/${id}`).then((d)=>{
        console.log(d.data);
        setmyform(d.data);
    })
    }
...
const submiteditpage = ()=>{
    axios.patch(`http://localhost:4500/user/${id}`,myform).then((d)=>{
      console.log(d.data);
          ...
          <div className='container-fluid'>
            <div className='row'>
              <div className='col-12 p-3 text-center'>
                ...
                <h2 className='mt-3'>Json edit page</h2>
              </div>
            </div>
            <div className="row">
